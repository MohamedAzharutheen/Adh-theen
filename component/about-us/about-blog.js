  ...
  <section className='container mt70'>
              <div className='row '>
               ...
               <div className='pos-r mmt40' >
                <Image className='mdn' src={"/assets/images/aboutus/about-blog.jpg"} style={{width:"350px",height:"550px"}} width={505} height={567} alt='' loading='lazy'/>
                <Image className='dn mdb '  src={"/assets/images/aboutus/about-blog.jpg"} style={{width:"auto",height:"auto"}} width={290} height={357} alt='' loading='lazy'/>
               ...
               <div className='col-12 col-md-6 col-lg-4 pdt156'>
