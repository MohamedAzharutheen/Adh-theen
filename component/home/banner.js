  ...
  return (
   ...
   <div className='df fjsa fac  pdt40 mfdc '>
    ...
    <ScrollAnimation direction="left" delay={0.1}>
      ...
      <p className={`fs19 mfs-16 mt32`}>Embark on a sacred journey to Makkah and Madinah with <strong> Ath-Theen </strong> all-inclusive Hajj and Umrah packages. Experience the profound spirituality of performing the rituals in the heart of Islam's holiest cities, with expert guidance and personalized services from <strong> Ath-Theen </strong> ensuring a smooth, fulfilling pilgrimage.</p>
      <div className="mt50">
