        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12 col-md-12 col-lg-6 df fdc fjc mpdt24'>
             ...
             <Link href={"tel: 8124289972"}>  <button className='enquiry-btn  cw fs-19 mfs-16 fw5'>Our Packages</button> </Link>
               <Link href={"/"}> <button className='enquiry-btn fs-19 mfs-16 cw drk-clr fw5'>Get Instant Call</button> </Link>
               </div>
            </div>
          </div>
        </div>
